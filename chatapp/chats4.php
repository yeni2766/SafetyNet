...
session_start();
	...
	$sql = "select * from safetynet where pin = '".$_SESSION['pin']."'";
...
<div class ="col-md-10 shadow-sm p-3 bg-light bb" style = "height:400px;  position:relative; bottom:400px; right:230px;" id = "chartscreen">
<h1 class="display-4">Add a Friend</h1>
<div class = "form-group">

	<input type = "text" name = "search_text" id = "search_text" placeholder = "Search for friends pins here!" class = 'form-control' onkeyup = "myfunction3()">
</div>
