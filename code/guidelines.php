	...
	<div class = "container">
		...
		<!--the contents of the page-->
			<div class ="col-md-10 shadow-sm p-3 bg-light bb" style = "height:1000px;" id = "chartscreen">
				<h1 class="display-4">Online Safety Guidelines</h1><br>
-	Anyone can lie on the internet<br>
-	Only give information about yourself to people you trust.<br>
-	To report cyber predators, call 999, or make a report to www.ceop.gov.uk<br>
-	Child Pornography – Do not send this anywhere and of you come across a user promoting it, report the user.<br>
-	Always report your parents if you feel distressed due to online activities
