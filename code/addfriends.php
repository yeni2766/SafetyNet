			...
			<div class = "container">
				<div class ="row">
					<div class ="col-md-10 shadow-sm p-3 bg-light bb" style = "height:400px;" id = "chartscreen">
						<h1 class="display-4">Add a Friend</h1>
							<div class = "form-group">
							<!--the user will search here for pins here-->
...
$(document).ready(function(){
	//it reaches for results when user stops typing
	$('#search_text').keyup(function(){
		var friendpin = $(this).val();
		//the friend pin that the parent types down is passed through another page
	if (friendpin != '')
	{
		$.ajax({
			//AJAX is used and search.php seaches for the PIN and brings back the data to the dashboard without refreshing the page so it 
...
function sendscommand(constant, i){
alert(i);
