...
<div class = "wrapper">
	...
	<div id = "links">
		...
		<a href="whatiscyberbullying.php">What is Cyberbullying</a>
		<a href="typesofcyberbullying.php">Types of Cyberbullying</a>
		<a href="impactofcyberbullying.php">Impact of Cyberbullying</a>
		<a href="recommendationsforparents.php">Recommendations for parents</a>
		...
		<div class ="row">
			<div class ="col-md-10 shadow-sm p-3 bg-light bb" style = "height:400px;" id = "chartscreen">
				<h1 class="display-4">How to use?</h1>
					<p>Welcome to the cyberbullying course provided by SafetyNet! <br> <br>On this platform, You can learn about internet safety and the issue regarding cyberbullying and ways you can protect your child. This is so you can be well informed about the world of today and understand the perspective of your child in order to provide guidance.
					Click on the topics on the sidebar to be informed on everything related to cyberbullying and internet safety.
					</p>
