			...
			<div class = "container">
				<div class ="row">
					<div class ="col-md-10 shadow-sm p-3 bg-light bb" style = "height:400px;" id = "chartscreen">
						<h1 class="display-4">Key Information</h1>
						You and Your Child's PIN is <?php echo $row['pin'];?><br>
						Your Password is <?php echo $row['parentspassword'];?><br>
						Your Child Password is <?php echo $row['childpassword'];?><br>
