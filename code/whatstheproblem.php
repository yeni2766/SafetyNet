...
<h1 class="display-4">What is the problem?</h1><br>
The internet can be entertaining for you guys, with the number of things that you can do can be limitless. Unfortunately, this leads to strangers taking advantage of others therefore it is important that you guys are prepared to avoid the predators that roam around on the internet. Predators are all over the internet and use it as a tool to harass, harm, even commit extreme crimes like kidnapping or rape. Predators can be located in your chat rooms or group chats as they may seek to develop a relationship with users. Predators on the internet most likely do not look like how you may imagine them in your mind. It could be women, men, old or young people, it can be anyone that just has computer knowledge. 
		</div>
		</div>
</div>
